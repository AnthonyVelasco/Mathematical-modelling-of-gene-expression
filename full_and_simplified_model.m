...
legend('Transcription factor X', 'Active transcription factor Xn', 'Initial Data','Location','best');
hold off
shg
...
legend('Free promoter Dy', 'Occupied promoter DyXn', 'Initial Data','Location','best');
hold off
shg
...
legend('mRNA my', ' Protein Y', 'Initial Data','Location','best');
hold off
shg
...
y=[y1,y2];
disp('Equilibrium points of the Simplified Model');
% The solve function solves the system allowing to obtain the equilibrium points.
sols = solve([f1,f2], y);
% The double function has been used to display the results in decimal 
% numbers.
disp(double(sols.y1));
disp(double(sols.y2));
...
disp('Equilibrium points of the 4-dimensional Model');
% The solve function solves the system allowing to obtain the equilibrium points.
sols = solve([f1,f2,f3,f4], y);
% The double function has been used to display the results in decimal 
% numbers.
disp(double(sols.y1));
disp(double(sols.y2));
